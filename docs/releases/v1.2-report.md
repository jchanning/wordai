...
3. ✅ Uploaded JAR to Oracle Cloud instance (132.145.64.140)
...
View live logs:
```bash
ssh -i ~/.ssh/arm-wordai.key opc@132.145.64.140 'sudo journalctl -u wordai -f'
```

Check status:
```bash
ssh -i ~/.ssh/arm-wordai.key opc@132.145.64.140 'sudo systemctl status wordai'
```

Restart service:
```bash
ssh -i ~/.ssh/arm-wordai.key opc@132.145.64.140 'sudo systemctl restart wordai'
```

View cache statistics:
```bash
ssh -i ~/.ssh/arm-wordai.key opc@132.145.64.140 'curl http://localhost:8080/api/cache-stats 2>/dev/null'
```
...
```bash
# Via SSH
ssh -i ~/.ssh/arm-wordai.key opc@132.145.64.140 'sudo sed -i "s/wordai-1.2.jar/wordai-1.1.jar/" /etc/systemd/system/wordai.service && sudo systemctl daemon-reload && sudo systemctl restart wordai'
```
...
**Live at:** http://132.145.64.140:8080
