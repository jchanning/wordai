...
**Target:** Oracle Cloud ARM Instance (132.145.64.140)
...
**Application URL:** http://132.145.64.140:8080

**Server Details:**
- IP Address: 132.145.64.140
- SSH User: opc
...
View logs:
```powershell
ssh -i C:\Users\johnm\.ssh\arm-wordai.key opc@132.145.64.140 'sudo journalctl -u wordai -f'
```

Check status:
```powershell
ssh -i C:\Users\johnm\.ssh\arm-wordai.key opc@132.145.64.140 'sudo systemctl status wordai'
```

Restart service:
```powershell
ssh -i C:\Users\johnm\.ssh\arm-wordai.key opc@132.145.64.140 'sudo systemctl restart wordai'
```
...
1. Test the web UI at http://132.145.64.140:8080
